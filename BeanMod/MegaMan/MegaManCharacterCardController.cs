...
{
    public class MegaManCharacterCardController : HeroCharacterCardController
    {
        public MegaManCharacterCardController(Card card, TurnTakerController turnTakerController)
