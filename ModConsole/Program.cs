...
namespace BeanMod.ModConsole // this has to be this way to work around an EngineCommon issue, will be fixed soon.
{
    /*
    ...
    */
    ...
    class MainClass
    {
        public static Dictionary<string, Assembly> ModAssemblies = new Dictionary<string, Assembly>
        {
            ...
            { "BeanMod", typeof(BeanMod.MegaMan.MegaManCharacterCardController).Assembly } // replace with your own namespace and type
        };
